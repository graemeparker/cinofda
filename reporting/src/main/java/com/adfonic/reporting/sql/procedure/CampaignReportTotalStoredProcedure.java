...
import com.adfonic.reporting.sql.mapper.CampaignTotalDtoMapper;

public class CampaignReportTotalStoredProcedure extends BaseStoredProcedure {
	

	public CampaignReportTotalStoredProcedure(DataSource ds, String name) {
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result", new CampaignTotalDtoMapper()));
		compile();
	}

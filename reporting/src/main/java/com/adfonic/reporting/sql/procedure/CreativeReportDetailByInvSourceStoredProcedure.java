...
import com.adfonic.reporting.sql.mapper.CreativeReportDetailByInvSourceDtoMapper;

public class CreativeReportDetailByInvSourceStoredProcedure extends	BaseStoredProcedure {

	public CreativeReportDetailByInvSourceStoredProcedure(DataSource ds, String name) {
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result", new CreativeReportDetailByInvSourceDtoMapper()));
		compile();
	}
}

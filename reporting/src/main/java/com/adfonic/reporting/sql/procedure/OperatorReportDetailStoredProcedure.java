...
import com.adfonic.reporting.sql.mapper.OperatorDetailDtoMapper;

public class OperatorReportDetailStoredProcedure extends BaseStoredProcedure {
	public OperatorReportDetailStoredProcedure(DataSource ds, String name) {
		super(ds, name);
		...
		declareParameter(new SqlReturnResultSet("result", new OperatorDetailDtoMapper()));
		compile();
	}
}

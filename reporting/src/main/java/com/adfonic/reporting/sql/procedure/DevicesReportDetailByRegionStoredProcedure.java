...
import com.adfonic.reporting.sql.mapper.DeviceDetailByRegionDtoMapper;

public class DevicesReportDetailByRegionStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByRegionStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByRegionDtoMapper()));
		compile();
	}

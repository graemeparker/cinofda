...
import com.adfonic.reporting.sql.mapper.DeviceDetailByBrandDtoMapper;

public class DevicesReportDetailByBrandStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByBrandStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByBrandDtoMapper()));
		compile();
	}

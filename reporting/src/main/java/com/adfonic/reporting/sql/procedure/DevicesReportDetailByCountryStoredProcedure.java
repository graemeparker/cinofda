...
import com.adfonic.reporting.sql.mapper.DeviceDetailByCountryDtoMapper;

public class DevicesReportDetailByCountryStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByCountryStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByCountryDtoMapper()));
		compile();
	}

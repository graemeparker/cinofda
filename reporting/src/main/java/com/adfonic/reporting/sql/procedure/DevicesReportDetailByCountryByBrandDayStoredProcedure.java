...
import com.adfonic.reporting.sql.mapper.DeviceDetailByCountryByBrandDayDtoMapper;

public class DevicesReportDetailByCountryByBrandDayStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByCountryByBrandDayStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByCountryByBrandDayDtoMapper()));
		compile();
	}

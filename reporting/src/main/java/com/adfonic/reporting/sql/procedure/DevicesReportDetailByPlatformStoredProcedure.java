...
import com.adfonic.reporting.sql.mapper.DeviceDetailByPlatformDtoMapper;

public class DevicesReportDetailByPlatformStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByPlatformStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByPlatformDtoMapper()));
		compile();
	}

...
import com.adfonic.reporting.sql.mapper.DeviceDetailByCountryByPlatformDtoMapper;

public class DevicesReportDetailByCountryByPlatformStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByCountryByPlatformStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByCountryByPlatformDtoMapper()));
		compile();
	}

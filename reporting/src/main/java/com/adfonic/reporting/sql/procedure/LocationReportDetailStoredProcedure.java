...
import com.adfonic.reporting.sql.mapper.LocationDetailDtoMapper;

public class LocationReportDetailStoredProcedure extends BaseStoredProcedure {
	public LocationReportDetailStoredProcedure(DataSource ds, String name) {
		super(ds, name);
		...
		declareParameter(new SqlReturnResultSet("result", new LocationDetailDtoMapper()));
		compile();
	}
}

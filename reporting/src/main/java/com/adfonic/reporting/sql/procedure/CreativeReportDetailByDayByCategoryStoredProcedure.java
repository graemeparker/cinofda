...
import com.adfonic.reporting.sql.mapper.CreativeReportDetailByDayByCategoryDtoMapper;

public class CreativeReportDetailByDayByCategoryStoredProcedure extends BaseStoredProcedure {

	public CreativeReportDetailByDayByCategoryStoredProcedure(DataSource ds,
			String name) {
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result", new CreativeReportDetailByDayByCategoryDtoMapper()));
		compile();
	}

...
import com.adfonic.reporting.sql.mapper.DeviceDetailByRegionDayDtoMapper;

public class DevicesReportDetailByRegionDayStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByRegionDayStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByRegionDayDtoMapper()));
		compile();
	}

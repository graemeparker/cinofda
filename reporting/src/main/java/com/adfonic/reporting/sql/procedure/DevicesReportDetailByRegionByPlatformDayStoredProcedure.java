...
import com.adfonic.reporting.sql.mapper.DeviceDetailByRegionByPlatformDayDtoMapper;

public class DevicesReportDetailByRegionByPlatformDayStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByRegionByPlatformDayStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByRegionByPlatformDayDtoMapper()));
		compile();
	}

...
import com.adfonic.reporting.sql.mapper.CreativeReportDetailByDayByCategoryByInvSourceDtoMapper;

public class CreativeReportDetailyByDayByCategoryByInvSourceStoredProcedure extends BaseStoredProcedure {

	public CreativeReportDetailyByDayByCategoryByInvSourceStoredProcedure(
			DataSource ds, String name) {
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result", new CreativeReportDetailByDayByCategoryByInvSourceDtoMapper()));
		compile();
	}

...
import com.adfonic.reporting.sql.mapper.DeviceDetailByCountryDayDtoMapper;

public class DevicesReportDetailByCountryDayStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByCountryDayStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByCountryDayDtoMapper()));
		compile();
	}

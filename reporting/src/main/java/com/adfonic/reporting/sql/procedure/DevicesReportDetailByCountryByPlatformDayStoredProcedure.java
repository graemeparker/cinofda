...
import com.adfonic.reporting.sql.mapper.DeviceDetailByCountryByPlatformDayDtoMapper;

public class DevicesReportDetailByCountryByPlatformDayStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByCountryByPlatformDayStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByCountryByPlatformDayDtoMapper()));
		compile();
	}

...
import com.adfonic.reporting.sql.mapper.CreativeReportDetailByCategoryByInvSourceDtoMapper;

public class CreativeReportDetailyByCategoryByInvSourceStoredProcedure extends BaseStoredProcedure {

	public CreativeReportDetailyByCategoryByInvSourceStoredProcedure(
		...
		declareParameter(new SqlReturnResultSet("result", new CreativeReportDetailByCategoryByInvSourceDtoMapper()));
		compile();
	}

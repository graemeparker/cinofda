...
public class CreativeReportDetailByDayStoredProcedure<T> extends ResultSetProcedure<T> {
	public CreativeReportDetailByDayStoredProcedure(DataSource ds, RowMapper<T> mapper) {
		super(ds, "proc_return_adv_cre_report_detail_by_day", mapper);

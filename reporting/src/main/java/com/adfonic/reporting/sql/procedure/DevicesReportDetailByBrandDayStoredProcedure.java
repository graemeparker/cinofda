...
import com.adfonic.reporting.sql.mapper.DeviceDetailByBrandDayDtoMapper;

public class DevicesReportDetailByBrandDayStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByBrandDayStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByBrandDayDtoMapper()));
		compile();
	}

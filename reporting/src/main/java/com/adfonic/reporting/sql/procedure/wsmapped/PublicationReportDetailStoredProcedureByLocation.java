...
public class PublicationReportDetailStoredProcedureByLocation extends BaseStoredProcedure{

    public PublicationReportDetailStoredProcedureByLocation(DataSource ds) {
        super(ds, "proc_return_pub_pubn_loc_detail");
        ...
        declareParameter(new SqlReturnResultSet("result", 
                new StatisticsGroupDtoMapper(Tag.getTemplateTags(TAG.PUBLICATION, TAG.ADSLOT, TAG.COUNTRY), new BasicPubSideStatsDtoMapper())));
    }

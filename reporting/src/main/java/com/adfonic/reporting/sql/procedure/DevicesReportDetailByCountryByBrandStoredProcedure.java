...
import com.adfonic.reporting.sql.mapper.DeviceDetailByCountryByBrandDtoMapper;

public class DevicesReportDetailByCountryByBrandStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByCountryByBrandStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByCountryByBrandDtoMapper()));
		compile();
	}

...
public class PublicationReportSummaryStoredProcedure extends BaseStoredProcedure {

    public PublicationReportSummaryStoredProcedure(DataSource ds) {
        super(ds, "proc_return_pub_pubn_summary");
        ...
        declareParameter(new SqlReturnResultSet("result", new PubSideStatisticsSummaryDtoMapper(TAG.PUBLICATION)));
    }

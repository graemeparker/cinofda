...
import com.adfonic.reporting.sql.mapper.DeviceDetailByPlatformDayDtoMapper;

public class DevicesReportDetailByPlatformDayStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByPlatformDayStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByPlatformDayDtoMapper()));
		compile();
	}

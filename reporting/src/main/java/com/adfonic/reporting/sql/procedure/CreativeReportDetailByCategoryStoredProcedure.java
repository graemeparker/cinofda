...
import com.adfonic.reporting.sql.mapper.CreativeReportDetailByCategoryDtoMapper;

public class CreativeReportDetailByCategoryStoredProcedure extends BaseStoredProcedure {

	public CreativeReportDetailByCategoryStoredProcedure(DataSource ds,
			String name) {
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result", new CreativeReportDetailByCategoryDtoMapper()));
		compile();
	}

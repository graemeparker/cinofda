...
import com.adfonic.reporting.sql.mapper.DeviceDetailByRegionByBrandDayDtoMapper;

public class DevicesReportDetailByRegionByBrandDayStoredProcedure extends BaseStoredProcedure {

	public DevicesReportDetailByRegionByBrandDayStoredProcedure(DataSource ds, String name){
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result",new DeviceDetailByRegionByBrandDayDtoMapper()));
		compile();
	}

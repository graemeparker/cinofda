...
userAgents.put("iPhone (iOS 4.0)", "Mozilla/5.0 (iPod touch; U; CPU iPhone OS 4_0 like Mac OS X; en-us) AppleWebKit/532.9 (KHTML, like Gecko) Version/4.0.4 Mobile/8A260b Safari/531.21.10");
...
<form method="get" action="doPlugin.jsp">
<input type="hidden" name="run" value="true"/>

<tr>
<th align=right>Plugin Creative:</th>
<td align=left><select name="creativeExternalID">
<% for (CreativeDto creative : adserverDomainCache.getPluginCreatives()) {
    PluginCreativeInfo pluginCreativeInfo = adserverDomainCache.getPluginCreativeInfo(creative);
%>
<option value="<%= creative.getExternalID() %>"><%= creative.getCampaign().getName() %> - <%= creative.getName() %> (<%= pluginCreativeInfo.getPluginName() %> - <%= domainCache.getFormatById(creative.getFormatId()).getSystemName() %>)</option>
<% } %>
</select></td>
</tr>

<tr>
<th align=right>AdSpace:</th>
<td align=left><select name="adSpaceExternalID">
<% for (Map.Entry<String,String> entry : adSpaces.entrySet()) { %>
...
<tr>
<th align=right>Custom Device:</th>
<td align=left><input type="text" size=80 name="userAgentCustom" value=""/> (user-agent)</td>
</tr>
...
<tr>
<th align=right>Custom IP Address:</th>
<td align=left><input type="text" size=15 name="ipAddressCustom" value=""/> (XXX.XXX.XXX.XXX)</td>
</tr>

<tr>
<th align=right>CountryDto Override:</th>
...
<tr>
<th align=right>Zip/PostalCode Override:</th>
<td align=left><input type="text" name="postalCode" size=6 value=""/></td>
</tr>

<tr>
<th align=right>US State Override:</th>
...
<tr>
<th align=right>DMA ID Override:</th>
<td align=left><input type="text" name="dma" size=6 value=""/></td>
</tr>

<tr>
<th align=right>TimeZone Override:</th>
...
"206.47.78.128", "Bell Canada CA", "CA",
"213.162.64.0", "T-Mobile Austria", "AT",
"62.120.64.0", "Mobily", "SA",
"86.96.226.0", "Etisalat United Arab Emirates", "AE",
};
%>

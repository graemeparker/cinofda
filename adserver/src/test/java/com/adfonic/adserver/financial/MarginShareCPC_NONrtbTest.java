...
public class MarginShareCPC_NONrtbTest {

    MarginShareCPC_NONrtb testObj = new MarginShareCPC_NONrtb();
    ...
    public void csvAdServed() throws IOException {
        new TestHelper().testCSV(testObj, "MarginShare CPC on NonRTB-AD_SERVED.csv", AdAction.AD_SERVED);
    }

    @Test
    public void csvClick() throws IOException {
        new TestHelper().testCSV(testObj, "MarginShare CPC on NonRTB-CLICK.csv", AdAction.CLICK);
    }

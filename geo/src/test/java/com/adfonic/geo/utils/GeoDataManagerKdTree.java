...
public class GeoDataManagerKdTree extends AbstractGeoCsvDataManagerKDTree<ChinesePostalCode> {

    public GeoDataManagerKdTree(File dataFile, int checkForUpdatesPeriodSec) {

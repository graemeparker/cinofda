...
public class OptimisationUserInterfaceRemovedPublicationDetailPaginatedStoredProcedure extends OptimisationUserInterfaceBaseStoredProcedure {

	public OptimisationUserInterfaceRemovedPublicationDetailPaginatedStoredProcedure(DataSource ds) {
		this(ds, "proc_return_adv_cam_opti_report_detail");
	}
	
	public OptimisationUserInterfaceRemovedPublicationDetailPaginatedStoredProcedure(DataSource ds, String name) {
		super(ds,name);
		...
		declareParameter(new SqlReturnResultSet("result", new OptimisationUserInterfaceRemovedPublicationDtoMapper(false)));
		compile();
	}

...
public class OptimisationUserInterfaceLivePublicationDetailCountStoredProcedure extends OptimisationUserInterfaceBaseStoredProcedure {

	public OptimisationUserInterfaceLivePublicationDetailCountStoredProcedure(DataSource ds) {
		this(ds, "proc_return_adv_cam_opti_report_detail_record_count");
	}
	
	public OptimisationUserInterfaceLivePublicationDetailCountStoredProcedure(DataSource ds, String name) {
		super(ds,name);

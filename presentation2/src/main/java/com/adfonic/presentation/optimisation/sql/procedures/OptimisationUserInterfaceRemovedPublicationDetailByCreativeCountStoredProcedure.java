...
public class OptimisationUserInterfaceRemovedPublicationDetailByCreativeCountStoredProcedure extends OptimisationUserInterfaceBaseStoredProcedure {

	public OptimisationUserInterfaceRemovedPublicationDetailByCreativeCountStoredProcedure(DataSource ds) {
		this(ds, "proc_return_adv_cre_opti_report_detail_record_count");
	}
	
	public OptimisationUserInterfaceRemovedPublicationDetailByCreativeCountStoredProcedure(DataSource ds, String name) {
		super(ds,name);
	...
	public Long run(
			...
			String campaignId, 
			Integer dateRange) {
        Map<String, Object> data = super.execute(advertiserId, campaignId, dateRange, 1);
